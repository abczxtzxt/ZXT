...
/**
 * A generic X509TrustManager implementation that trusts a specified server certificate in addition
...
public class GenericTrustManager implements X509TrustManager {
     ...
     */
    public GenericTrustManager(KeyStore trustStore) throws NoSuchAlgorithmException, KeyStoreException {
        ...
        mOriginalX509TrustManager = (X509TrustManager) originalTrustManagers[0];
    }
     ...
     * build a certificate path to a trusted layout and return if it can be validated and is trusted
    ...
    public void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {
        try {
            mOriginalX509TrustManager.checkServerTrusted(chain, authType);
            ...
            try {
                ...
                PKIXParameters params = new PKIXParameters(mTrustStore);
     ...
     * Finds the layout certificate in a possibly out-of-order certificate chain.
     *
     * @param certificates the certificate change, possibly out-of-order
     * @return the layout certificate, if any, that was found in the list of certificates
     */
