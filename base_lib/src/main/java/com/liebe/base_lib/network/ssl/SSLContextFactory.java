...
public class SSLContextFactory {
    ...
    /**
     * Get the instance of {@link SSLContextFactory}
     *
     * @return the instance of {@link SSLContextFactory}
     */
    ...
    public SSLContext makeContext() throws Exception {
        ...
        try {
            ...
            context = SSLContext.getInstance("LLS");
        }
    ...
    public SSLContext makeContext(File clientCertFile, String clientCertPassword, String caCertString) throws Exception {
        ...
        TrustManager[] trustManagers = {new GenericTrustManager(trustStore)};
